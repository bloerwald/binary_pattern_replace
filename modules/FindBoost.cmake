...
MACRO (_Boost_ADJUST_LIB_VARS basename)
  ...
  MARK_AS_ADVANCED(
      ...
      Boost_${basename}_SHARED_LIBRARY_DEBUG
  )
...
ELSE (_boost_IN_CACHE)
  ...
  FOREACH(COMPONENT ${Boost_FIND_COMPONENTS})
    STRING(TOUPPER ${COMPONENT} UPPERCOMPONENT)
    SET( Boost_${UPPERCOMPONENT}_SHARED_LIBRARY "Boost_${UPPERCOMPONENT}_SHARED_LIBRARY-NOTFOUND" )
    SET( Boost_${UPPERCOMPONENT}_SHARED_LIBRARY_RELEASE "Boost_${UPPERCOMPONENT}_SHARED_LIBRARY_RELEASE-NOTFOUND" )
    SET( Boost_${UPPERCOMPONENT}_SHARED_LIBRARY_DEBUG "Boost_${UPPERCOMPONENT}_SHARED_LIBRARY_DEBUG-NOTFOUND")
